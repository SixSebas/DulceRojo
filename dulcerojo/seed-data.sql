...
('Choco Chips Clásica', 'Galleta con chispas de chocolate.', 2000, 15,
 (SELECT id FROM categorias WHERE nombre='Clásicas'), NULL),
('Red Velvet Rellena', 'Rellena de queso crema.', 2500, 8,
 (SELECT id FROM categorias WHERE nombre='Rellenas'), NULL),
('Doble Chocolate', 'Chocolate blanco y cacao.', 2200, 3,
 (SELECT id FROM categorias WHERE nombre='Clásicas'), NULL),
('Edición Navidad', 'Galleta decorada para Navidad.', 3000, 0,
 (SELECT id FROM categorias WHERE nombre='Edición Especial'), NULL),
('Mantequilla de Maní', 'Con maní tostado.', 2300, 12,
 (SELECT id FROM categorias WHERE nombre='Clásicas'), NULL),
('Chocolate Blanco y Macadamia', 'Galleta premium.', 3200, 10,
 (SELECT id FROM categorias WHERE nombre='Premium'), NULL);
